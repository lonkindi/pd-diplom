# Generated by Django 3.1.1 on 2021-02-10 17:39
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            managers=[
                ('objects', shop.models.MyUserManager()),
            ],
        ),
        migrations.CreateModel(
            name='Category',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.BooleanField(default=True, verbose_name='Магазин работает?')),
                ('filename', models.FileField(upload_to='data/price/', verbose_name='Актуальный прайс-лист')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='confirm_email_tokens', to=settings.AUTH_USER_MODEL, verbose_name='The MyUser which is associated to this password reset token')),
            ],
            options={
